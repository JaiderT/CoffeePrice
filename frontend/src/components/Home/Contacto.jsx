...
export default function Contacto() {
  ...
  const contenido = (
    <main className="bg-[#F0E8D5] font-sans min-h-screen">
      <section className="py-16 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-[#2C1A0E] mb-4">Contáctanos</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-start">
            ...
            {/* Formulario */}
            <form onSubmit={handleSubmit} noValidate className="bg-[#fffdf8] border border-[#d4b896] rounded-2xl p-8 space-y-5">
              <p className="text-[10px] font-semibold tracking-widest uppercase text-[#a0784e] mb-1">Envíanos un mensaje</p>
              {enviado && (
              ...
              <div>
                <label htmlFor="nombre" className="block text-[#4a2f18] text-sm font-medium mb-1.5">Nombre</label>
                <input id="nombre" name="nombre" type="text" value={formData.nombre} onChange={handleChange}
                  placeholder="Tu nombre"
                  className={`w-full bg-[#faf5ec] border rounded-xl px-4 py-3 text-sm text-[#2C1A0E] placeholder-[#b09070] focus:outline-none focus:ring-2 focus:ring-[#8b5e34] transition ${errors.nombre ? "border-red-400" : "border-[#d4b896]"}`} />
                {errors.nombre && <p className="text-red-500 text-xs mt-1">{errors.nombre}</p>}
              </div>
              <div>
                <label htmlFor="correo" className="block text-[#4a2f18] text-sm font-medium mb-1.5">Correo electrónico</label>
                <input id="correo" name="correo" type="email" value={formData.correo} onChange={handleChange}
                  placeholder="tucorreo@ejemplo.com"
                  className={`w-full bg-[#faf5ec] border rounded-xl px-4 py-3 text-sm text-[#2C1A0E] placeholder-[#b09070] focus:outline-none focus:ring-2 focus:ring-[#8b5e34] transition ${errors.correo ? "border-red-400" : "border-[#d4b896]"}`} />
              ...
              <div>
                ...
                <input id="asunto" name="asunto" type="text" value={formData.asunto} onChange={handleChange}
              ...
              <div>
                <label htmlFor="mensaje" className="block text-[#4a2f18] text-sm font-medium mb-1.5">Mensaje</label>
                <textarea id="mensaje" name="mensaje" rows="4" value={formData.mensaje} onChange={handleChange}
                  placeholder="Escribe tu mensaje..."
                  className={`w-full bg-[#faf5ec] border rounded-xl px-4 py-3 text-sm text-[#2C1A0E] placeholder-[#b09070] focus:outline-none focus:ring-2 focus:ring-[#8b5e34] transition resize-none ${errors.mensaje ? "border-red-400" : "border-[#d4b896]"}`} />
            ...
            <div className="flex flex-col gap-4">
              <div className="bg-[#fffdf8] border border-[#d4b896] rounded-2xl p-8">
                <p className="text-[10px] font-semibold tracking-widest uppercase text-[#a0784e] mb-5">Información de contacto</p>
              ...
              <div className="bg-[#fffdf8] border border-[#d4b896] rounded-2xl px-8 py-6">
                <p className="text-[10px] font-semibold tracking-widest uppercase text-[#a0784e] mb-4">Horario de atención</p>
              ...
              <div className="bg-[#fffdf8] border border-[#d4b896] rounded-2xl px-8 py-6">
                <p className="text-[10px] font-semibold tracking-widest uppercase text-[#a0784e] mb-4">Síguenos</p>
                <div className="flex gap-3 flex-wrap">
                  <a href="https://www.facebook.com/profile.php?id=61575364127180" target="_blank" rel="noopener noreferrer"
