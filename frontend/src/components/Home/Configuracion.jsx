  ...
  return (
    <div className="min-h-screen bg-[#F5ECD7] px-8 py-6">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-[#2C1A0E] text-2xl font-bold">Configuración</h1>
        <p className="text-gray-500 text-sm mt-1">Ajusta las preferencias de tu cuenta</p>
        <div className="bg-white rounded-2xl p-8 mt-6 text-center shadow-sm">
          <i className="fa-solid fa-gear text-[#C8A96E] text-4xl mb-4"></i>
