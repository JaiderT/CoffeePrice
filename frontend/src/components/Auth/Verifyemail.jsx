...
export default function VerifyEmail() {
  ...
  return (
    <div className="min-h-screen w-full bg-[#F0E8D5] flex items-center justify-center p-3 sm:p-4 md:p-6 relative overflow-hidden">
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 sm:w-6 sm:h-6 text-[#3B1F0A]/60 hover:text-[#3B1F0A] transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="relative z-10 h-full flex flex-col justify-between">
              <div>
                ...
                <p className="text-white/60 text-sm md:text-base leading-relaxed mb-6 md:mb-8 max-w-md">
                  Verifica tu correo para proteger tu cuenta y empezar a consultar precios en tu municipio.
                </p>
              </div>
          ...
          <div className="w-full lg:w-1/2 bg-white p-5 sm:p-6 md:p-8 lg:p-10">
            ...
            {success ? (
              <div className="space-y-4 text-center py-4">
                <div className="w-20 h-20 rounded-full bg-green-50 border-2 border-green-200 flex items-center justify-center text-5xl mx-auto mb-2 animate-bounce-slow">
                  ✅
                </div>
                <h2 className="text-2xl sm:text-3xl font-black text-[#3B1F0A] font-serif">
                  ¡Cuenta creada{userName ? `, ${userName}` : ""}!
                </h2>
                <p className="text-xs sm:text-sm text-gray-400 leading-relaxed">
                  Tu cuenta fue verificada exitosamente. Estás siendo redirigido...
                </p>
                <div className="flex items-center justify-center gap-2 pt-2">
                  <svg className="animate-spin h-4 w-4 text-[#C8814A]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                    <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                    <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                  </svg>
                  <span className="text-xs text-[#C8814A] font-semibold">Cargando precios...</span>
                </div>
              </div>
            ...
            pendiente ? (
              <div className="space-y-4">
                <div className="text-center mb-4">
                  <div className="w-16 h-16 rounded-2xl bg-[#C8814A]/10 flex items-center justify-center text-4xl mx-auto mb-4">⏳</div>
                  <h2 className="text-2xl sm:text-3xl font-black text-[#3B1F0A] mb-2 font-serif">¡Correo verificado!</h2>
                  <p className="text-xs sm:text-sm text-gray-400 leading-relaxed">
              ...
              <div className="space-y-4">
                <div className="text-center mb-4">
                  <div className="w-16 h-16 rounded-2xl bg-[#C8814A]/10 flex items-center justify-center text-4xl mx-auto mb-4">✉️</div>
                  <h2 className="text-2xl sm:text-3xl font-black text-[#3B1F0A] mb-2 font-serif">Verifica tu correo</h2>
                  <p className="text-xs sm:text-sm text-gray-400">
                    Enviamos un código de 6 dígitos a
                  </p>
                  <p className="text-sm font-semibold text-[#C8814A] mt-1">
                    {maskEmail(email)}
                  </p>
                </div>
                ...
                <form onSubmit={handleVerify} className="space-y-4">
                  {/* Inputs del código */}
                  <div>
                    <label className="block text-xs font-semibold text-[#3B1F0A] mb-3 uppercase tracking-wide text-center">
                    ...
                    >
                      {code.map((digit, i) => (
                        <input
                          ...
                          className={`w-11 h-14 sm:w-12 sm:h-14 text-center text-xl font-black rounded-xl border-2 bg-gray-50/50 text-[#3B1F0A] focus:outline-none transition-all
                            ${digit ? "border-[#C8814A] bg-[#C8814A]/5" : "border-[#C8814A]/20"}
                            ${error ? "border-red-400 bg-red-50" : ""}
                            focus:ring-2 focus:ring-[#C8814A]/30 focus:border-[#C8814A] focus:bg-white`}
                        />
                      ))}
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    className="w-full py-2.5 sm:py-3 rounded-xl text-white text-sm font-bold shadow-lg transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] disabled:opacity-60 disabled:cursor-not-allowed disabled:hover:scale-100 relative overflow-hidden group bg-linear-to-r from-[#3D1F0F] to-[#7A4020] hover:from-[#4a2815] hover:to-[#8a4a28]"
                  >
                    <span className="absolute inset-0 bg-linear-to-r from-white/0 via-white/20 to-white/0 -translate-x-full group-hover:translate-x-full transition-transform duration-700" />
                ...
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-xs">
                    <span className="px-3 bg-white text-gray-400">¿No recibiste el código?</span>
                  </div>
                </div>
